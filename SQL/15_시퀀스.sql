...
/*
    # 시퀀스
        ...
        CREATE SEQUENCE 시퀀스명
                        ...
                        [CYCLE | NOCYCLE] - 마지막 값에도달하면 순환 여부 설정
...
-- 시퀀스.nextval : 해당 시퀀스의 다음 자동생성 번호를 받아온다. 
--      (다음 번호를 생성한 시퀀스는 다시는 예전 번호로 돌아갈 수 없다.)
SELECT empp_seq.nextval FROM dual;
-- 시퀀스.currval : 현재 시퀀스의 번호를 받아온다.
SELECT empp_seq.currval FROM dual;

TRUNCATE TABLE coffees; -- 롤백 없이 모든 행 삭제
